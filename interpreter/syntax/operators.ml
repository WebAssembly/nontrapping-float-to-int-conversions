...
let i32_trunc_s_sat_f32 = Convert (I32 I32Op.TruncSSatF32)
let i32_trunc_u_sat_f32 = Convert (I32 I32Op.TruncUSatF32)
let i32_trunc_s_sat_f64 = Convert (I32 I32Op.TruncSSatF64)
let i32_trunc_u_sat_f64 = Convert (I32 I32Op.TruncUSatF64)
...
let i64_trunc_s_sat_f32 = Convert (I64 I64Op.TruncSSatF32)
let i64_trunc_u_sat_f32 = Convert (I64 I64Op.TruncUSatF32)
let i64_trunc_s_sat_f64 = Convert (I64 I64Op.TruncSSatF64)
let i64_trunc_u_sat_f64 = Convert (I64 I64Op.TruncUSatF64)
