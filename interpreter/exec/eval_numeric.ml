...
struct
  ...
  let cvtop op v =
    ...
    | TruncSSatF32 -> I32 (I32_convert.trunc_s_sat_f32 (F32Op.of_value 1 v))
    | TruncUSatF32 -> I32 (I32_convert.trunc_u_sat_f32 (F32Op.of_value 1 v))
    | TruncSSatF64 -> I32 (I32_convert.trunc_s_sat_f64 (F64Op.of_value 1 v))
    | TruncUSatF64 -> I32 (I32_convert.trunc_u_sat_f64 (F64Op.of_value 1 v))
...
struct
  ...
  let cvtop op v =
    ...
    | TruncSSatF32 -> I64 (I64_convert.trunc_s_sat_f32 (F32Op.of_value 1 v))
    | TruncUSatF32 -> I64 (I64_convert.trunc_u_sat_f32 (F32Op.of_value 1 v))
    | TruncSSatF64 -> I64 (I64_convert.trunc_s_sat_f64 (F64Op.of_value 1 v))
    | TruncUSatF64 -> I64 (I64_convert.trunc_u_sat_f64 (F64Op.of_value 1 v))
